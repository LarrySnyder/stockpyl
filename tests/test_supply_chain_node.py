...
class TestStateVariables(unittest.TestCase):
	...
	def test_example_6_1_per_23(self):
		...
		# TODO: redo the in-transit tests after fix how those are counted
		...
		# self.assertAlmostEqual(network.nodes[2].state_vars[23].in_transit_from(None), 6.031269092+5.491333776, places=6)
		...
		# self.assertAlmostEqual(network.nodes[2].state_vars[23].in_transit, 6.031269092+5.491333776, places=6)
		...
		self.assertAlmostEqual(network.nodes[2].state_vars[23].on_order, 11.52260287, places=6)
		self.assertAlmostEqual(network.nodes[0].state_vars[23].inventory_position, 0.497397132+5.992602868, places=6)
		self.assertAlmostEqual(network.nodes[1].state_vars[23].inventory_position, 0.038666224+5.491333776, places=6)
		self.assertAlmostEqual(network.nodes[2].state_vars[23].inventory_position, -0.832602868+11.52260287, places=6)
		# self.assertAlmostEqual(network.nodes[0].state_vars[23].echelon_on_hand_inventory, 0.497397132, places=6)
		# self.assertAlmostEqual(network.nodes[1].state_vars[23].echelon_on_hand_inventory, 6.528666223999999, places=6)
		# self.assertAlmostEqual(network.nodes[2].state_vars[23].echelon_on_hand_inventory, 11.187397132, places=6)
		# self.assertAlmostEqual(network.nodes[0].state_vars[23].echelon_inventory_level, 0.497397132, places=6)
		# self.assertAlmostEqual(network.nodes[1].state_vars[23].echelon_inventory_level, 6.528666223999999, places=6)
		# self.assertAlmostEqual(network.nodes[2].state_vars[23].echelon_inventory_level, 11.187397132, places=6)
		# self.assertAlmostEqual(network.nodes[0].state_vars[23].echelon_inventory_position, 0.497397132+5.992602868, places=6)
		# self.assertAlmostEqual(network.nodes[1].state_vars[23].echelon_inventory_position, 6.528666223999999+5.491333776, places=6)
		# self.assertAlmostEqual(network.nodes[2].state_vars[23].echelon_inventory_position, 11.187397132+11.52260287, places=6)
	...
	def test_example_6_1_per_38(self):
		...
		# self.assertAlmostEqual(network.nodes[1].state_vars[38].in_transit_to(network.nodes[0]), 5.968205296, places=6)
		# self.assertAlmostEqual(network.nodes[2].state_vars[38].in_transit_to(network.nodes[1]), 5.869623842, places=6)
		# self.assertAlmostEqual(network.nodes[0].state_vars[38].in_transit_from(network.nodes[1]), 5.968205296, places=6)
		# self.assertAlmostEqual(network.nodes[1].state_vars[38].in_transit_from(network.nodes[2]), 5.869623842, places=6)
		# self.assertAlmostEqual(network.nodes[2].state_vars[38].in_transit_from(None), 5.567783089+5.465282344, places=6)
		# self.assertAlmostEqual(network.nodes[0].state_vars[38].in_transit, 5.968205296, places=6)
		# self.assertAlmostEqual(network.nodes[1].state_vars[38].in_transit, 5.869623842, places=6)
		# self.assertAlmostEqual(network.nodes[2].state_vars[38].in_transit, 5.567783089+5.465282344, places=6)
		self.assertAlmostEqual(network.nodes[0].state_vars[38].on_order, 6.65089457, places=6)
		self.assertAlmostEqual(network.nodes[1].state_vars[38].on_order, 6.212689274, places=6)
		self.assertAlmostEqual(network.nodes[2].state_vars[38].on_order, 11.03306543, places=6)
		self.assertAlmostEqual(network.nodes[0].state_vars[38].inventory_position, -0.16089457+6.65089457, places=6)
		self.assertAlmostEqual(network.nodes[1].state_vars[38].inventory_position, -0.682689274+6.212689274, places=6)
		self.assertAlmostEqual(network.nodes[2].state_vars[38].inventory_position, -0.343065432+11.03306543, places=6)
		# self.assertAlmostEqual(network.nodes[0].state_vars[38].echelon_on_hand_inventory, 0, places=6)
		# self.assertAlmostEqual(network.nodes[1].state_vars[38].echelon_on_hand_inventory, 5.968205296, places=6)
		# self.assertAlmostEqual(network.nodes[2].state_vars[38].echelon_on_hand_inventory, 11.837829138, places=6)
		# self.assertAlmostEqual(network.nodes[0].state_vars[38].echelon_inventory_level, -0.16089457, places=6)
		# self.assertAlmostEqual(network.nodes[1].state_vars[38].echelon_inventory_level, 5.807310726, places=6)
		# self.assertAlmostEqual(network.nodes[2].state_vars[38].echelon_inventory_level, 11.676934568, places=6)
		# self.assertAlmostEqual(network.nodes[0].state_vars[38].echelon_inventory_position, -0.16089457+6.65089457, places=6)
		# self.assertAlmostEqual(network.nodes[1].state_vars[38].echelon_inventory_position, 5.807310726+6.212689274, places=6)
		# self.assertAlmostEqual(network.nodes[2].state_vars[38].echelon_inventory_position, 11.676934568+11.03306543, places=6)

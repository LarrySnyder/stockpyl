...
class TestProductsByRawMaterial(unittest.TestCase):
	...
	def test_multiproduct_5_7(self):
		...
		self.assertListEqual(nodes[0].products_by_raw_material(raw_material=2, return_indices=True), [0])
		self.assertListEqual(nodes[0].products_by_raw_material(raw_material=3, return_indices=True), [0])
		self.assertListEqual(nodes[1].products_by_raw_material(raw_material=2, return_indices=True), [0])
		self.assertListEqual(nodes[1].products_by_raw_material(raw_material=3, return_indices=True), [0, 1])
		self.assertListEqual(nodes[1].products_by_raw_material(raw_material=4, return_indices=True), [1])
		self.assertListEqual(nodes[2].products_by_raw_material(raw_material=5, return_indices=True), [2, 3])
		self.assertListEqual(nodes[2].products_by_raw_material(raw_material=6, return_indices=True), [4])
		self.assertListEqual(nodes[3].products_by_raw_material(raw_material=5, return_indices=True), [2])
		self.assertListEqual(nodes[3].products_by_raw_material(raw_material=6, return_indices=True), [4])
		self.assertListEqual(nodes[4].products_by_raw_material(raw_material=nodes[4]._external_supplier_dummy_product.index, return_indices=True), [5, 6])

		self.assertListEqual(nodes[0].products_by_raw_material(raw_material=2), [prods[0]])
		self.assertListEqual(nodes[0].products_by_raw_material(raw_material=3), [prods[0]])
		self.assertListEqual(nodes[1].products_by_raw_material(raw_material=2), [prods[0]])
		self.assertListEqual(nodes[1].products_by_raw_material(raw_material=3), [prods[0], prods[1]])
		self.assertListEqual(nodes[1].products_by_raw_material(raw_material=4), [prods[1]])
		self.assertListEqual(nodes[2].products_by_raw_material(raw_material=5), [prods[2], prods[3]])
		self.assertListEqual(nodes[2].products_by_raw_material(raw_material=6), [prods[4]])
		self.assertListEqual(nodes[3].products_by_raw_material(raw_material=5), [prods[2]])
		self.assertListEqual(nodes[3].products_by_raw_material(raw_material=6), [prods[4]])
		self.assertListEqual(nodes[4].products_by_raw_material(raw_material=nodes[4]._external_supplier_dummy_product.index), [prods[5], prods[6]])

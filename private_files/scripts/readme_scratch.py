...
# 	echelon_holding_cost={3: 4, 2: 3, 1: 1}, #[4, 3, 1],
# 	local_holding_cost={3: 4, 2: 7, 1: 8}, #[4, 7, 8],
# 	shipment_lead_time={3: 1, 2: 1, 1: 2},
# 	stockout_cost={1: 40, 2: 0, 3: 0},
# 	demand_type='N',
# 	mean=10,
...
# #S_star, C_star = {3: 44.1689463285519, 2: 34.93248526934437, 1: 25.69602421013684}, 227.15328525645054
